...
// Open 2 links for 2020-2021
document.getElementById('link-20-21').addEventListener('click', function(event) {
    event.preventDefault(); // Prevent the default anchor behavior
    window.open('https://frc-events.firstinspires.org/2020', '_blank'); // Open the first link
    window.open('https://frc-events.firstinspires.org/2021', '_blank'); // Open the second link
});